...
lablel_imie = Label(ramka_formularz, text='Imie')
lablel_imie.grid(row=1, column=0, sticky=W)
...
label_miejscowosc_szczegoly_obiektu = Label(ramka_szczegoly_obiektow, text='Miejscowosc:')
